...
| **Factorization** | `slides/factorization/l01-02-main-deck/` | `l01-02-main.mp4` | `Pre S3 Maths L01-02 - More about Factorization (2025).pptx` | ✅ auto-exported ~248s |
...
| `slides/factorization/l01-02-quiz-deck/` | `l01-02-quiz-ans.mp4` | `Pre S3 Maths L01-02 - More about Factorization Quiz (ANS) james.pptx` |
...
Viewer: `shared/ppt-deck-viewer.js` + `shared/ppt-deck-viewer.css` — each folder needs `index.html` with `data-ppt-title` and `data-ppt-video`.
